 ...
 *
 * Stores and retrieves Buttonizer account information (user, site, plan)
 * from wp_options using the plugin name prefix.
 *
...
class Account
{
    ...
    private static function initialize()
    {
        ...
        // Register options
        register_setting($name, $name . "_account", [
            'type' => 'array',
        ...
        // Load settings
        self::$data = get_option($name . "_account", []);
    }
    ...
    public static function syncToDatabase(object $data): bool
    {
        ...
        // Save account data
        update_option(PluginConfig::name() . '_account', self::$data);
