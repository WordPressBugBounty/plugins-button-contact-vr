 ...
 *
 * Handles plugin settings updates from the admin dashboard.
 *
 * @package BZContactButton\Core\Api\Settings
 *
 * @license proprietary
 * Modified by buttonizer on 17-September-2026 using {@see https://github.com/BrianHenryIE/strauss}.
 */

namespace BZContactButton\Core\Api\Settings;
...
class UpdateSettings
{
    ...
    {
        register_rest_route(PluginConfig::name(), '/settings', [
            [
                'methods'  => ['POST'],
                'args' => [
                    'data' => [
